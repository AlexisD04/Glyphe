...
def print_traceroute_logo():
    ...
    print(r"\__   __/(  ____ )(  ___  )(  ____ \(  ____ \(  ____ )(  ___  )|\     /|\__   __/(  ____ \ ")
    print(r"   ) (   | (    )|| (   ) || (    \/| (    \/| (    )|| (   ) || )   ( |   ) (   | (    \/ ")
    print(r"   | |   | (____)|| (___) || |      | (__    | (____)|| |   | || |   | |   | |   | (__    ")
    print(r"   | |   |     __)|  ___  || |      |  __)   |     __)| |   | || |   | |   | |   |  __)   ")
    print(r"   | |   | (\ (   | (   ) || |      | (      | (\ (   | |   | || |   | |   | |   | (      ")
    print(r"   | |   | ) \ \__| )   ( || (____/\| (____/\| ) \ \__| (___) || (___) |   | |   | (____/\ ")
    print(r"   )_(   |/   \__/|/     \|(_______/(_______/|/   \__/(_______)(_______)   )_(   (_______/")
